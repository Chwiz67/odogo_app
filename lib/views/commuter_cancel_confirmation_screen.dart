...
class CommuterCancelConfirmationScreen extends StatelessWidget {
  const CommuterCancelConfirmationScreen({super.key});
  ...
  void _confirmCancel(BuildContext context) {
    ...
    // Pop all the way back to the Commuter Home Dashboard
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 1. Live Dark Map Background (Locked)
          FlutterMap(
            options: const MapOptions(
              initialCenter: LatLng(26.5123, 80.2329), // IIT Kanpur
              initialZoom: 16.0,
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () => Navigator.pop(context), // Dismisses the popup
